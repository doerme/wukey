...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		options = {
			...
			bottomOffset: 15,			// Distance of the balloon from bottom
		...
		intl = {
			...
			zh_cn: '<div class="icopng fl" style="width:57px;"><img src="view/touch/images/common/touch-icon114.png?131202" width="57" height="57"></div>请按 %icon 添加“唯品会触屏版”到%device <span class="bTi">主屏幕</span>。',
			zh_tw: '<div class="icopng fl" style="width:57px;"><img src="view/touch/images/common/touch-icon114.png?131202" width="57" height="57"></div>請按 %icon 添加“唯品會觸屏版”到%device <span class="bTi">主螢幕</span>。'
		};
