var VsmWebConfig = function() {
    ...
    VsmScroll = function() {
        var a = {
            ...
            b = function(a) {
                if (a) {
                    this.element = a, this.child = this.element.children[0], this.dom = {
                        elem: $(this.child),
        ...
        return b.prototype = {
            ...
            onTouchStart: function(a) {
                ...
                }, this.isScrolling = void 0, this.deltaX = 0, this.deltaY = 0, a.stopPropagation()
            },
    ...
    VsmFonEffect = function() {
        var a = $("#cart_list"),
            b = $('[data-isRegister="check"]'),
            c = $('[data-countTemporary="true"]'),
            d = $('[data-jumpTo="true"]'),
            e = $('[data-bindmethods="psw"]'),
            f = {
                show: function() {
                    var a = detectUser();
                    "" != a.istempuser && !isNaN(a.istempuser) && a.istempuser ? VsmCart.VsmDialog('<p style="text-align:center;display:block;">如有账号，点击登录！</p>', {
                        title: '<span style="text-align:center;display:block;">您尚未登录</span>',
                        setClass: "ui-modal-btn-c",
                        overClose: !1,
                        buttons: !0,
                        type: "defined",
                        onCloseCallBack: !0,
                        buttonsCus: [{
                            ...
                            name: "我没有账号",
                            attribute: !0,
                            mars_sead: "cart_pay_pop_no-account_btn"
                        }],
                        buttonsPos: 2,
                        buttonsStyle: "btn-purple",
                        onDoComplete: function(a, b) {
                            b.oncomplete(!1), self.location.href = "user-login.html"
                        },
                        onDoCompleteTo: function(a, b) {
                            b.oncomplete(!1), self.location.href = "cart-edit-receive-massage.html"
                        }
                    }) : self.location.href = "" != a.isParameter ? "cart-checkout.html?f=" + a.isParameter : "cart-checkout.html"
                },
                register: function() {
                    var a = VsmwebForm.validate,
                        b = $(this),
                        c = $(this).parents('[data-register="send"]'),
                        d = {
                            elem: b,
                            pars: c,
                            consignee: c.find('input[name="consignee"]'),
                            mobile: c.find('input[name="mobile"]'),
                            captcha: c.find('input[name="captcha"]'),
                            captchaImg: c.find("img#captcha")
                        };
                    if (!a.tiggerIsEmpty(d.consignee.val()) && "" == d.consignee.val()) return VsmwebForm.erBlackDialog("请填写收货人姓名"), d.consignee.focus(), VmPageEffect.sharkError(d.consignee.parent().parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (a.tiggerIsEmpty(d.consignee.val()) && !VsmwebForm.dataType.c.test($.trim(d.consignee.val()))) return VsmwebForm.erBlackDialog("请填写1~8位中文姓名"), d.consignee.focus(), VmPageEffect.sharkError(d.consignee.parent().parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (!a.tiggerIsEmpty(d.mobile.val()) && "" == d.mobile.val()) return VsmwebForm.erBlackDialog("手机号码不能为空"), d.mobile.focus(), VmPageEffect.sharkError(d.mobile.parent().parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (a.tiggerIsEmpty(d.mobile.val()) && !VsmwebForm.dataType.m.test($.trim(d.mobile.val()))) return VsmwebForm.erBlackDialog("手机号码格式错误"), d.mobile.focus(), VmPageEffect.sharkError(d.mobile.parent().parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (!a.tiggerIsEmpty(d.captcha.val()) && "" == d.captcha.val()) return VsmwebForm.erBlackDialog("请输入验证码"), d.captcha.focus(), VmPageEffect.sharkError(d.captcha.parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    var e = {
                        url: "ajaxapi-verifyuserphone.html?",
                        data: {
                            consignee: d.consignee.val(),
                            mobile: d.mobile.val(),
                            captcha: d.captcha.val()
                        },
                        dataType: "json",
                        type: "POST"
                    };
                    e.error = function() {
                        d.captchaImg.attr("src", "index.php?m=captcha&" + Math.random()), VsmwebForm.erBlackDialog("网络延时，请刷新页面重试！")
                    }, e.success = function(a) {
                        d.captchaImg.attr("src", "index.php?m=captcha&" + Math.random()), a && null != a && void 0 != a ? 1 == a.code ? ("" != a.userId && null != a.userId && Cookie.Set("wap_free_reg_id", a.userId, 24, "vip.com", "/"), c.next().find('input[name="consignee"]').val(d.consignee.val()), c.next().find('input[name="mobile"]').val(d.mobile.val()), d.pars.hide().next().show()) : 3 == a.code && a.url.length > 0 ? (VsmwebForm.erBlackDialog(a.msg), self.location.href = a.url) : -2 == a.code ? VsmCart.VsmDialog('<p style="text-align:center;">该手机码已被注册，请登录</p>', {
                            title: '唯品会提醒您<a href="http://www.vip.com/account/password.php" class="fr colorblue">忘记密码？</a>',
                            setClass: "ui-modal-btn-c",
                            overClose: !1,
                            closeBtn: !1,
                            buttons: !0,
                            ...
                            buttonsCus: [{
                                ...
                                name: "登录",
                                attribute: !0,
                                mars_sead: "receive-massage_pop_login_btn"
                            }],
                            buttonsPos: 2,
                            buttonsStyle: "btn-purple",
                            onDoComplete: function(a, b) {
                        ...
                        }) : VsmwebForm.erBlackDialog(-1 == a.code ? a.msg : a.msg) : VsmwebForm.erBlackDialog("网络延时，请刷新页面重试！")
                    }, $.ajax(e)
                },
                setPassWord: function() {
                    var a = VsmwebForm.validate,
                        ...
                        d = {
                            elem: b,
                            pars: c,
                            psw: c.find('input[name="password"]'),
                            data: auth_data("", hex_md5($.trim(c.find('input[name="password"]').val())), "")
                        };
                    if (!a.tiggerIsEmpty(d.psw.val()) && "" == d.psw.val()) return VsmwebForm.erBlackDialog("请输入密码"), d.psw.focus(), VmPageEffect.sharkError(d.psw.parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (a.tiggerIsEmpty(d.psw.val()) && (d.psw.val().length < 6 || d.psw.val().length > 20)) return VsmwebForm.erBlackDialog("请输入6-20位密码"), d.psw.focus(), VmPageEffect.sharkError(d.psw.parent(), "ui-note-error", !1, 0, 5, 50), !1;
                    if (!isNaN(d.psw.val()) || "-1" != d.psw.val().search(VsmwebForm.dataType.s)) return VsmwebForm.erBlackDialog("请使用字母和数字组合"), d.psw.focus(), !1;
                    var e = {
                        url: "ajaxapi-savatempuserpwd.html?",
                        data: {
                            udata: d.data
                        },
                        dataType: "json",
                    ...
                    e.error = function() {
                        ...
                        a && null != a && void 0 != a ? 1 == a.code ? (VsmCart.VsmDialog("设置密码成功，页面正在跳转", {
                            setClass: "ui-success",
                            position: [{
                                top: 0
                            }, {
                        ...
                        }, 1e3)) : VsmwebForm.erBlackDialog(a.msg) : VsmwebForm.erBlackDialog("网络延时，请刷新页面重试！")
                    }, $.ajax(e)
                },
                jumpLinks: function() {
                    var a = $(this);
                    dom = {
                    ...
                    }, "" != dom.links && isNaN(dom.links) && VsmCart.VsmDialog('<p style="text-align:center">动动手指设置密码吧，支付安全又快捷！</p>', {
                        title: "唯品会友情提醒您",
                        setClass: "ui-modal-btn-c",
                        overClose: !1,
                        buttons: !0,
                        ...
                        onDoCompleteTo: function(a, b) {
                            b.oncomplete(!1), self.location.href = location.href + "&mtp=1"
                        }
                    })
                }
            },
            g = {
                countdown: function() {
                    var a = $('[data-countTemporary="true"]'),
                        b = {
                            elem: a,
                            ...
                            onEndComplete: function() {
                                this.children().html("00:00"), VsmCart.VsmDialog('<p style="text-align:center;">购物车超时了<br />请重新选购商品</p>', {
                                    title: "唯品会友情提醒您",
                                    setClass: "ui-modal-btn-c",
                                    overClose: !1,
                                    buttons: !0,
                                    ...
                                    buttonsCus: [{
                                        name: "回首页逛逛",
                                        attribute: !1,
                                        mars_sead: "edit-detail-receive-massage_pop_back-to-home_btn"
                                    }],
                                    buttonsPos: 1,
                                    buttonsStyle: "btn-purple",
                                    onDoComplete: function(a, b) {
            ...
            h = {
                init: function() {
                    var a = {
                        psw: e.parent().parent().find('input[name="password"]')
                    };
            ...
            i = {
                bindEvents: function() {
                    a.off("click.login.dialog", '[data-islogin="true"]').on("click.login.dialog", '[data-islogin="true"]', f.show), b.off("click.registe.check").on("click.registe.check", f.register), e.off("click.password.set").on("click.password.set", f.setPassWord), d.off("click.jump.psw").on("click.jump.psw", f.jumpLinks)
                }
            },
            j = {
                init: function() {
                    i.bindEvents(), c.length && g.countdown(), e.length && h.init()
                }
            };
        return {
            init: j.init
    ...
    var a = $('[data-GetBrand="more"]'),
        ...
        k = {
            getBrandData: function(a) {
                a.elem.hide().before('<div class="loading"><img src="view/touch/images/common/loading-big.gif" alt="loading" />加载中</div>'), $.ajax({
                    ...
                    success: function(b) {
                        a.elem.show().prev().fadeOut(function() {
                            $(this).remove(), null != b && void 0 != b && b && b.length > 0 ? ($.each(b, function(c) {
                                var d = b[c];
                                if (0 == d.brand_id) {
                                    {
                                        var e = $("<div />", {
                                        ...
                                        $("<h1 />").html(d.brand_name).appendTo(e), $("<span />").html(d.detailurl).appendTo(e)
                                    }
                                    ...
                                    if ("" != d.banner_image_url && null != d.banner_image_url) {
                                        $("<div />", {
                                            "class": "mark"
                                        }).html("<img src=" + d.banner_image_url + ' width="88">').appendTo(g)
                                    }
                                    g.appendTo(f), k.appendTo(j), l.appendTo(j), j.appendTo(f), f.appendTo(a.insertObj)
                                }
                    ...
                    error: function() {
                        VsmCart.VsmDialog("网络延时，加载品牌列表失败，请刷新页面重试...", {
                            title: "唯品会提醒您"
                        }), a.elem.prev().fadeOut("fast", function() {
            ...
            tiggerDetailinit: function() {
                ...
                b.type = "" != b.check && "string" == typeof b.check && "normal" == b.check ? !0 : !1, null != b.pid && (b.elem.hide(), b.child.show(), k.tiggerDetailData(b))
            },
            ...
            tiggerAccordionInit: function() {
                k.tiggerAccordion($(this))
            },
            tiggerAccordion: function(a) {
                var b = {
                    elem: a,
                    next: a.next(),
                    addStyle: a.parent().data("style"),
                    child: a.children().filter("span:eq(1)")
                };
        ...
        l = {
            ...
            slidePageLeft: function() {
                ...
                if (!this.elem.next().is(":visible")) {
                    ...
                    this.elem.next().undelegate('[data-dropClose="true"]', "click.drop.close").delegate('[data-dropClose="true"]', "click.drop.close", l.slidePageBottom), document.addEventListener("touchmove", l.touchEvent, !1)
                }
            },
            slidePageRight: function() {
                ...
                if (!this.elem.next().is(":hidden")) {
                    ...
                    this.elem.next().animate(b, "fast", function() {
                        $(this).hide()
                    }).parent().removeClass("active"), document.removeEventListener("touchmove", l.touchEvent, !1)
                }
            },
        ...
        n = {
            ...
            tiggerClienHide: function() {
                ...
                b.pars.is(":visible") && b.pars.fadeOut(), b.pars.fadeOut(), Cookie.Set("WAP[clientClose]", 1, "", "", "/")
            }
        },
        o = {
        ...
        p = {
            bindEvents: function() {
                a.off("click.asyn.loading").on("click.asyn.loading", k.getBrandinit), c.off("click.detail.loading").on("click.detail.loading", k.tiggerDetailinit), d.children().children().filter("a").off("click.made.classify").on("click.asyn.classify", l.slideCateinit), e.children().find("li").off("click.drop.menu").on("click.drop.menu", l.slideMenuinit), h.off("click.jump.link").on("click.jump.link", o.tiggerJumpLinks), i.children().filter("h3,p").off("click.accordion.down").on("click.accordion.down", k.tiggerAccordionInit)
            },
            init: function() {
                p.bindEvents(), f.length > 0 && m.bindwindowCategory(), b.length > 0 && n.tiggerDowninit()
            }
        };
    return {
        init: p.init,
        cateInit: m.cateInit,
        accordion: k.tiggerAccordion
    }
}();
$(function() {
    VsmwebEffect.init()
    ...
    var a, b = {
            ...
            tiggerCartTime: function(c) {
                var d, f = {
                    ...
                    i = {},
                    j = c.elem;
                "string" == typeof h.time && (h.time = parseInt(h.time, 10)), !isNaN(h.time) && h.time > 0 && (i.startTime = h.time, i.nowTime = Math.round((new Date).getTime() / 1e3), i.endTime = i.nowTime + i.startTime, function k() {
                    var c = {};
                    ...
                    if (f.html(""), sec = i.nowTime < i.endTime ? i.endTime - i.nowTime : 0, null != h.showMsg && (c.msg = h.showMsg), h.showMin && (c.min = b.addZero(h.minDigit, Math.floor(sec / 60 % 60))), c.sec = b.addZero(h.minDigit, Math.floor(sec % 60)), !(i.endTime > i.nowTime)) {
                        if (h.stopTips) d = h.stopTips, f.html(d);
                            ...
                            case "remove":
                                break;
                            case "remain":
                                h.onEndCallBack && "function" == typeof h.onEndComplete && h.onEndComplete.call(j), !$('[data-getvercode="code"]').length && g("您的商品已超时被清空，继续抢购吧", {
                                    title: "唯品会友情提醒您",
                                    buttons: !0
                                });
                                break;
                            ...
                            case "reload":
                                if (h.jump) {
                                    for (var l in c) c[l] = "00", h.block.clone().addClass(h.timeUnitCls[l]).text(c[l]).appendTo(f), h.timeStamp && h.block.clone().text(h.timeUnitCls[l]).appendTo(f);
                    ...
                    for (var l in c) h.block.clone().addClass(h.timeUnitCls[l]).text(c[l]).appendTo(f), h.timeStamp && h.block.clone().text(h.timeUnitCls[l]).appendTo(f);
                    i.nowTime = i.nowTime + h.interval / 1e3, a = setTimeout(k, h.interval), h.timeWarn && 300 === sec && !$('[data-OrderFrom="true"]').length && g('您的购物车只剩 <span class="fontred">5分钟</span> 时间，立即结算？', {
                        title: "唯品会友情提醒您",
                        buttons: !0,
                        type: "confirm",
        ...
        d = {
            ...
            tiggerDelGoods: function(a) {
                var b = arguments[1] ? parseInt(arguments[1]) : 0,
                    c = "确定从购物车中删除该商品吗？";
                b > 0 && (c = "删除或修改商品后，可能会导致已使用的红包，不满足条件而被自动取消使用，是否继续操作？"), 0 > a && !isNaN(a) ? "" : g(c, {
                    title: "删除商品",
                    overClose: !1,
                    buttons: !0,
                    type: "confirm",
                ...
                f.close(), g({
                    ...
                    success: function(a) {
                        if (f.close(), a && null != a && void 0 != a) {
                            if (a.out) return $("#cart_list").html(a.out), h.imgBrandEffect(), b.CartTimereset(), void i.cartTimeCensor();
                            g("网络加载异常，请刷新页面重试!", {
                                title: "友情提示",
                                overClose: !1,
                                closeBtn: !1
                ...
                c.Init = function() {
                    ...
                    if (e.overShow && (c.overlayer = $("<div>", {
                        ...
                        if (n && (c.footer = $("<div>", {
                            ...
                            $('<a href="javascript:void(0)" class="closeBtn">×</a>').on("click.modal.closeBtn", function(a) {
                    ...
                    }), c.setTimes = setTimeout(c.close, e.autoClose)), g(!1)
                }, c.close = function(a) {
                    var b;
    ...
    var a, b = $("#scroller_lBer"),
        ...
        m = {
            tiggerDepotSet: function(a, b) {
                $.ajax({
                    ...
                    type: "POST",
                    success: function(a) {
                        location.href = a && null != a && void 0 != a ? a : a, b.oncomplete(!0)
                    },
                    error: function() {
            ...
            tiggerDepotDo: function(a, b) {
                ...
                d.hascart && d.Gcookie !== d.posi ? VsmCart.VsmDialog("更换收货地址后，购物车将会被清空，是否确认需要更换？", {
                    title: "唯品会友情提醒您",
                    overClose: !1,
                    buttons: !0,
                    type: "question",
                    onDoComplete: function(a, c) {
                        d.posi && m.tiggerDepotSet(d, b), c.oncomplete(!1)
                    }
            ...
            tiggerDepotInit: function(a) {
                ...
                b.closeBtn ? b.closeBtn : b.closeBtn = !1, b.modalHide ? b.modalHide : b.modalHide = !1, VsmCart.VsmDialog({
                    modal: a,
        ...
        n = {
            ...
            triggerBoxOpen: function(a) {
                a.openObj.children().append(a.closeHtml), a.openObj.fadeTo(1e3, 1), window.Touch_bigImgReview = new Swipe(document.getElementById("bid_goods"), {
                    startSlide: a.index,
                    callback: function(b, c) {
                        index = c, g.eq(index).hasClass("active") || VsmCart.imgcheck(g.eq(index), {
                            oncomplete: function(a, b, c) {
                ...
                }), a.openObj.children().find("em").filter(":eq(" + a.index + ")").addClass("on").siblings().removeClass("on"), n.triggerboxclose.call(a)
            },
            triggeropenbox: function() {
                ...
                !b.openObj.hasClass("open") && n.triggerBoxStyle.call(b), n.triggerBoxOpen(b)
            },
            FlickerNote: function(a, b, c, d, e) {
                var f = arguments[5] ? arguments[5] : !1,
                    ...
                    j = "",
                    e = e || 2;
                a.hasClass(b) && a.removeClass(b), c ? a = a : a.children().filter(":eq(" + d + ")"), f && $("body,html").animate({
                    scrollTop: a.offset().top - f
                }, 200), h || (h = setInterval(function() {
        ...
        o = {
            sliderMerchandise: function() {
                ...
                }), f.children().eq(0).addClass("on"), e.each(function() {
        ...
        p = {
            ...
            boxBuild: function(a, b) {
                a.markup = a.markup.replace("{vmsTxt}", b.txt), a.markup = a.markup.replace("{vmsBtn}", b.btn), $("body").append(a.markup), $box_holder = $("div.ui-center-overlay"), $box_overlay = $("div.overlayer"), $box_holder.css({
            ...
            boxInit: function(a) {
                var b = {
                    ...
                    c = $.extend(!0, {}, b, a);
                p.boxBuild(c, a), p.boxShowContent(c)
            }
        },
        q = {
                ...
                if (a && null != a && void 0 != a) {
                    {
                        ...
                        new Swipe(a, {
                            ...
                            callback: function(a, c) {
                                b.children().find("li").eq(c).children().find("img").hasClass("active") || b.children().find("li").eq(c).children().find("img").is(":visible") || b.children().find("li").eq(c).children().find("img").attr("src", b.children().find("li").eq(c).children().find("img").attr("data-img")).fadeIn(e.animationSpeed), f.eq(c).addClass("on").siblings().removeClass("on")
                            }
                        })
                    }
                    f.eq(e.startIndex).addClass("on").siblings().removeClass("on"), b.children().find("li").eq(e.startIndex).children().find("img").attr("src", b.children().find("li").eq(e.startIndex).children().find("img").attr("data-img")).fadeIn(e.animationSpeed).addClass("active")
                }
                if (d && null != d && void 0 != d) {
                    {
                        ...
                        new Swipe(d, {
                            startSlide: e.startIndex,
                            callback: function(a, b) {
                                g.eq(b).addClass("on").siblings().removeClass("on"), c.children().children("li").eq(b).children().find("img.q_icon").each(function() {
                                    $(this).attr("src", $(this).attr("data-srcimg")).fadeIn(e.animationSpeed)
                                })
                            }
                        })
                    }
                    g.eq(e.startIndex).addClass("on").siblings().removeClass("on"), c.children().children("li").eq(e.startIndex).children().find("img.q_icon").each(function() {
        ...
        v = {
            BindEvents: function() {
                d.off("click.openImages").on("click.openImages", n.triggeropenbox), h.children().filter(".class_tit").off("click.dropAccordion").on("click.dropAccordion", r.triggerAccordion), j.off("click.select.depot").on("click.select.depot", m.tiggerDepotBtn)
            },
        ...
        w = {
            NeedtoCensor: function() {
                d.length && o.sliderMerchandise(), $("#CartCountdown").length && oP.cartTimerRun(), i.length && l.tiggerDLlink()
            }
        },
        x = {
            init: function() {
                v.BindEvents(), v.BindBrowserEvents(), w.NeedtoCensor(), q.advertSlide()
            }
        };
    return {
        init: x.init,
    ...
    a.fn.smartlazyload = function(d) {
        function e() {
            ...
            g.each(function() {
                ...
                } else c.trigger("appear"), h.ajax_getdata && "pad" == h.data_Version && "" != h.data_productid ? c.trigger("ajaxsize") : h.ajax_getdata && "touch" == h.data_Version && "" != h.data_productid ? c.trigger("touch_ajaxsize") : h.ajax_getdata && "Get_Merstar" == h.data_Type && "" == h.data_productid && c.trigger(h.data_Version + "_" + h.data_Type)
            })
        }
        var f, g = this,
            h = {
